// ==UserScript==
// @name         KaHack! Ultimate Stealth
// @version      1.4.0
// @namespace    https://github.com/jokeri2222
// @description  Ultimate Kahoot hack with stealth mode and neon effects
...
(function() {
    ...
    // Rainbow mode functions (optimized)
        ...
        function applyRainbowColors() {
            ...
            buttons.forEach(button => {
                ...
                button.style.cssText = `
                    ...
                    box-shadow: ${colors.neonPulse} !important;
    ...
    // Create Neon UI with optimized animations
    ...
    // Create section function with optimized animations
    ...
    // Rainbow toggle button (original working version)
    ...
    function handleDrag(e) {
        ...
        dragFrame = requestAnimationFrame(() => {
            ...
            uiElement.style.transform = `translate(${x}px, ${y}px)`;
        });
    }
    ...
    document.addEventListener('mouseup', function() {
        if (isDragging) {
            ...
            const transform = uiElement.style.transform;
            const [x, y] = transform.match(/translate\((\d+)px, (\d+)px\)/).slice(1);
