...
// Add ALT+W feature label
const altWFeatureContainer = document.createElement('div');
altWFeatureContainer.style.textAlign = 'center';
altWFeatureContainer.style.margin = '1vw';
const altWLabel = document.createElement('span');
altWLabel.textContent = 'Press ALT+W to answer correctly';
altWLabel.style.fontFamily = '"Montserrat", "Noto Sans Arabic", "Helvetica Neue", Helvetica, Arial, sans-serif;';
altWLabel.style.fontSize = '1.5vw';
altWLabel.style.color = 'white';
altWFeatureContainer.appendChild(altWLabel);
uiElement.appendChild(altWFeatureContainer);
...
minimizeButton.addEventListener('click', () => {
    ...
    if (isMinimized) {
        ...
        altWFeatureContainer.style.display = 'none';
        ...
        altWFeatureContainer.style.display = 'block';
...
// ALT+W feature to answer correctly
