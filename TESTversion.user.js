...
keybindsLabel.innerHTML = 'Keybinds:<br>ALT+W - Answer correctly<br>ALT+S (hold) - Show answers<br>SHIFT+ALT - Toggle UI';
...
document.addEventListener('keydown', function(e) {
    ...
    if (e.key.toLowerCase() === 'w' && e.altKey && !e.shiftKey && info.questionNum !== -1 && questions[info.questionNum]) {
        e.preventDefault();
        e.stopPropagation();
    ...
    if (e.key.toLowerCase() === 's' && e.altKey && !e.shiftKey && info.questionNum !== -1 && questions[info.questionNum]) {
        e.preventDefault();
        e.stopPropagation();
        isAltSPressed = true;
    ...
    // SHIFT+ALT - Toggle UI visibility
    if (e.key.toLowerCase() === 'alt' && e.shiftKey) {
        e.preventDefault();
        e.stopPropagation();
